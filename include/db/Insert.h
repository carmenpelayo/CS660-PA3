 ...
 */
    ...
    private:
        TransactionId t;    // the transaction running the insert
        DbIterator *child;  // The child operator from which to read tuples to be inserted
        int tableId;        // The table in which to insert tuples
        TupleDesc td;
    protected:
        /**
    ...
    public:
         ...
         */
        Insert(TransactionId t, DbIterator *child, int tableId, const TupleDesc &td);
